  ...
  return (
    <>
      ...
      <p>
        ...
        love, care, and a diet that fuels their zest for life. NutriPup is not
        just an app; it's a compassionate companion for dog owners who aspire to
      ...
      <p>
        ...
        determining what's best can be overwhelming for pet parents. That's
        where NutriPup steps in - to demystify canine nutrition and make
      ...
      <p>
        ...
        We're dedicated to helping you understand your dog's nutritional needs
        and empowering you to make the best dietary choices for your furry
        family member.
      </p>
      ...
      <p>
        ...
        innovation. Our mission extends beyond a single pet; it's about
        impacting the well-being of dogs worldwide. Powered by vet-backed
        research and leveraging cutting-edge technology, NutriPup translates
      ...
      <p>
        ...
        improvement, ensuring that your trust in us contributes to a longer,
        healthier, and happier life for your dogs.
      </p>

      <p>
        Join us on this journey to nurture your NutriPup with the love and
