...
export default function Features() {
  return (
    <>
      ...
      <p>
        Unlock the secret to a healthier hound with NutriPup's innovative
        features. Tailor meals with our custom diet planner, track nutrient
        intake, and access a library of dog-friendly recipes. Every feature is a
        step towards a more vibrant, vivacious pup.
      </p>
